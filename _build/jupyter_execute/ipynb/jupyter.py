...
# - A more advanced exercise including Numpy operations is to [compute student grades using a complicated grading scheme.](https://classroom.github.com/a/2IRoHSuh)
# 
...
# 
# 1. [GitHub Learning Lab.](https://lab.github.com/) Especially the courses on [beginning](https://lab.github.com/everydeveloper/introduction-to-python) and [intermediate](https://lab.github.com/everydeveloper/intermediate-python) Python and [beginning](https://lab.github.com/githubtraining/first-day-on-github) and [intermediate](https://lab.github.com/githubtraining/first-week-on-github) GitHub. 
...
# 1. [The Coder's Apprentice](https://dodona.ugent.be/en/courses/296/). This includes lots of online exercises! 
...
# 1. [Python for Engineers and Scientists](https://www.linkedin.com/learning/python-for-engineers-and-scientists) (intermediate level)
