...
# <div class="toc"><ul class="toc-item"><li><span><a href="#The-One-Dimensional-Particle-in-a-Box" data-toc-modified-id="The-One-Dimensional-Particle-in-a-Box-3"><span class="toc-item-num">3&nbsp;&nbsp;</span>The One-Dimensional Particle in a Box</a></span><ul class="toc-item"><li><span><a href="#🥅-Learning-Objectives" data-toc-modified-id="🥅-Learning-Objectives-3.1"><span class="toc-item-num">3.1&nbsp;&nbsp;</span>🥅 Learning Objectives</a></span></li><li><span><a href="#Cyanine-Dyes" data-toc-modified-id="Cyanine-Dyes-3.2"><span class="toc-item-num">3.2&nbsp;&nbsp;</span>Cyanine Dyes</a></span></li><li><span><a href="#Postulate:-The-squared-magnitude-of-the-wavefunction-is-proportional-to-probability" data-toc-modified-id="Postulate:-The-squared-magnitude-of-the-wavefunction-is-proportional-to-probability-3.3"><span class="toc-item-num">3.3&nbsp;&nbsp;</span>Postulate: The squared magnitude of the wavefunction is proportional to probability</a></span></li><li><span><a href="#The-Wavefunctions-of-the-Particle-in-a-Box-(boundary-conditions)" data-toc-modified-id="The-Wavefunctions-of-the-Particle-in-a-Box-(boundary-conditions)-3.4"><span class="toc-item-num">3.4&nbsp;&nbsp;</span>The Wavefunctions of the Particle in a Box (boundary conditions)</a></span></li><li><span><a href="#Postulate:-The-wavefunction-of-a-system-is-determined-by-solving-the-Schrödinger-equation" data-toc-modified-id="Postulate:-The-wavefunction-of-a-system-is-determined-by-solving-the-Schrödinger-equation-3.5"><span class="toc-item-num">3.5&nbsp;&nbsp;</span>Postulate: The wavefunction of a system is determined by solving the Schrödinger equation</a></span></li><li><span><a href="#The-Wavefunctions-of-the-Particle-in-a-Box-(solution)" data-toc-modified-id="The-Wavefunctions-of-the-Particle-in-a-Box-(solution)-3.6"><span class="toc-item-num">3.6&nbsp;&nbsp;</span>The Wavefunctions of the Particle in a Box (solution)</a></span></li><li><span><a href="#Normalization-of-Wavefunctions" data-toc-modified-id="Normalization-of-Wavefunctions-3.7"><span class="toc-item-num">3.7&nbsp;&nbsp;</span>Normalization of Wavefunctions</a></span></li><li><span><a href="#Normalization-Check" data-toc-modified-id="Normalization-Check-3.8"><span class="toc-item-num">3.8&nbsp;&nbsp;</span>Normalization Check</a></span></li><li><span><a href="#The-Energies-of-the-Particle-in-a-Box" data-toc-modified-id="The-Energies-of-the-Particle-in-a-Box-3.9"><span class="toc-item-num">3.9&nbsp;&nbsp;</span>The Energies of the Particle in a Box</a></span></li><li><span><a href="#Zero-Point-Energy" data-toc-modified-id="Zero-Point-Energy-3.10"><span class="toc-item-num">3.10&nbsp;&nbsp;</span>Zero-Point Energy</a></span></li><li><span><a href="#Atomic-Units" data-toc-modified-id="Atomic-Units-3.11"><span class="toc-item-num">3.11&nbsp;&nbsp;</span>Atomic Units</a></span></li><li><span><a href="#Postulate:-The-wavefunction-contains-all-the-physically-meaningful-information-about-a-system." data-toc-modified-id="Postulate:-The-wavefunction-contains-all-the-physically-meaningful-information-about-a-system.-3.12"><span class="toc-item-num">3.12&nbsp;&nbsp;</span>Postulate: The wavefunction contains all the physically meaningful information about a system.</a></span></li><li><span><a href="#Postulate:-Observable-Quantities-Correspond-to-Linear,-Hermitian-Operators." data-toc-modified-id="Postulate:-Observable-Quantities-Correspond-to-Linear,-Hermitian-Operators.-3.13"><span class="toc-item-num">3.13&nbsp;&nbsp;</span>Postulate: Observable Quantities Correspond to Linear, Hermitian Operators.</a></span></li><li><span><a href="#Heisenberg-Uncertainty-Principle" data-toc-modified-id="Heisenberg-Uncertainty-Principle-3.14"><span class="toc-item-num">3.14&nbsp;&nbsp;</span>Heisenberg Uncertainty Principle</a></span></li><li><span><a href="#Double-Checking-the-Energy-of-a-Particle-in-a-Box" data-toc-modified-id="Double-Checking-the-Energy-of-a-Particle-in-a-Box-3.15"><span class="toc-item-num">3.15&nbsp;&nbsp;</span>Double-Checking the Energy of a Particle-in-a-Box</a></span></li><li><span><a href="#Visualizing-the-Particle-in-a-Box-Wavefunctions,-Probabilities,-etc." data-toc-modified-id="Visualizing-the-Particle-in-a-Box-Wavefunctions,-Probabilities,-etc.-3.16"><span class="toc-item-num">3.16&nbsp;&nbsp;</span>Visualizing the Particle-in-a-Box Wavefunctions, Probabilities, etc.</a></span></li><li><span><a href="#🪞-Self-Reflection" data-toc-modified-id="🪞-Self-Reflection-3.17"><span class="toc-item-num">3.17&nbsp;&nbsp;</span>🪞 Self-Reflection</a></span></li><li><span><a href="#🤔-Thought-Provoking-Questions" data-toc-modified-id="🤔-Thought-Provoking-Questions-3.18"><span class="toc-item-num">3.18&nbsp;&nbsp;</span>🤔 Thought-Provoking Questions</a></span></li><li><span><a href="#🔁-Recapitulation" data-toc-modified-id="🔁-Recapitulation-3.19"><span class="toc-item-num">3.19&nbsp;&nbsp;</span>🔁 Recapitulation</a></span></li><li><span><a href="#🔮-Next-Up..." data-toc-modified-id="🔮-Next-Up...-3.20"><span class="toc-item-num">3.20&nbsp;&nbsp;</span>🔮 Next Up...</a></span></li><li><span><a href="#📚-References" data-toc-modified-id="📚-References-3.21"><span class="toc-item-num">3.21&nbsp;&nbsp;</span>📚 References</a></span></li></ul></li></ul></div>
